...
function Footer() {
    ...
    return (
        // <footer className="w-full mt-16 h-screen bg-[#353232e6] relative">
        ...
        //                 />
        //             </svg>
        //             <span className="ml-4 text-lg font-bold">Organicia</span>
        //         </div>
        ...
        //                     <p className="mb-6 text-xl font-bold text-gray-200 ">Company</p>
        ...
        //     <MdOutlineKeyboardControlKey className='text-4xl font-extrabold ' onClick={scrollToTop} />
        // </div>
        ...
        <div className="mx-auto w-full">
            <footer className="w-full mt-16 h-screen bg-[#353232e6] relative">
                <div className="flex flex-col md:flex-row md:items-center">
                    {/* <span>
                        <img src={logo} alt="logo" className='bg-[#353232e6]' />
                    </span> */}
                    <div className="mt-4 grow md:ml-12 md:mt-0">
                        <p className="text-xl font-bold text-gray-200">
                            © 2024 Organic Harvest
                        </p>
                    </div>
                </div>
                <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mx-auto">
                    ...
                    <div className="mb-8 lg:mb-0">
                        <p className="mb-6 text-xl font-bold text-gray-200">Our Stores</p>
                        <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-200">
                            <li>Washington</li>
                            <li>New Hampshire</li>
                            <li>Maine</li>
                    ...
                    {/* <div className="mb-8 lg:mb-0">
                        <p className="mb-6 text-xl font-bold text-gray-200">Services</p>
                    ...
                    <div className="mb-8 lg:mb-0">
                        <p className="mb-6 text-xl font-bold text-gray-200">Legal</p>
                        <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-200">
                    ...
                    <div className="mb-8 lg:mb-0">
                        <p className="mb-6 text-xl font-bold text-gray-200">Social Links</p>
                        <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-200">
                            <li>Facebook</li>
                            <li>Twitter</li>
                            <li>Instagram</li>
